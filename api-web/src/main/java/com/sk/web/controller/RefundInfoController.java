...
public class RefundInfoController {
    ...
    public RefundInfo selectOne(@RequestBody RefundInfo t){
    ...
    public String insert(@RequestBody RefundInfo t) {
        RefundInfoService.insert(t);
        return "1";
    }
    ...
    public int delete(@RequestBody RefundInfo t){
    ...
    public int update(@RequestBody RefundInfo t){
