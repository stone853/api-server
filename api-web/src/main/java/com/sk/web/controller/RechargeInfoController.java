...
public class RechargeInfoController {
    ...
    public RechargeInfo selectOne(@RequestBody RechargeInfo t){
    ...
    public String insert(@RequestBody RechargeInfo t) {
        RechargeInfoService.insert(t);
        return "1";
    }
    ...
    public int delete(@RequestBody RechargeInfo t){
    ...
    public int update(@RequestBody RechargeInfo t){
